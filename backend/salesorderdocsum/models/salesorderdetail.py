# backend/salesorderdocsum/models/salesorderdetail.py
...
class SalesOrderDetail(BaseModel):
    ...
    belge_no = models.CharField(max_length=50, verbose_name="Belge Numarası", db_index=True)
    satici = models.CharField(max_length=100, verbose_name="Satıcı", blank=True, null=True, db_index=True)
    belge_tarih = models.DateField(verbose_name="Belge Tarihi", blank=True, null=True, db_index=True)
    teslim_tarih = models.DateField(verbose_name="Teslim Tarihi", blank=True, null=True, db_index=True)
    ...
    satir_durum = models.CharField(max_length=50, verbose_name="Satır Durumu", db_index=True)
    satir_no = models.CharField(max_length=50, verbose_name="Satır Durumu")
    kalem_kod = models.CharField(max_length=50, verbose_name="Kalem Kodu", db_index=True)
    kalem_tanimi = models.CharField(max_length=200, verbose_name="Kalem Tanımı", db_index=True)
    ...
    net_tutar_spb = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Net Tutar SPB", default=0.0)
