# backend/tunainssupplierpayment/models/closinginvoice.py
...
class ClosingInvoice(BaseModel):
    ...
    class Meta:
        indexes = [
            GinIndex(fields=['monthly_balances'], name='monthly_balances_gin_tuna'),  # değiştirdik
            models.Index(fields=['current_balance', 'cari_kod'], name='curr_bal_cari_kod_idx_tuna')  # değiştirdik
        ]
