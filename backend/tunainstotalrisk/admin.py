# backend/tunainstotalrisk/admin.py
...
class TunainsTotalRiskReportAdmin(ImportExportModelAdmin):
    resource_class = TunainsTotalRiskReportResource
...
admin.site.register(TunainsTotalRiskReport, TunainsTotalRiskReportAdmin)
