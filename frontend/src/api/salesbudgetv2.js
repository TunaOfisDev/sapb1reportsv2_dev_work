// frontend/src/api/salesbudgetv2.js
import axiosInstance from './axiosconfig';

const getsalesbudgetv2s = async () => {
  try {
    const response = await axiosInstance.get('salesbudgetv2/budgets/');
...
const fetchHanasalesbudgetv2Data = async () => {
  try {
...
const exportsalesbudgetv2ToXLSX = async () => {
  try {
    // responseType 'blob' olarak ayarlanmalıdır ki dosya olarak indirebilelim
    const response = await axiosInstance.get('salesbudgetv2/export-xlsx/', { responseType: 'blob' });
...
const salesbudgetv2 = {
  getsalesbudgetv2s,
  fetchHanasalesbudgetv2Data,
  exportsalesbudgetv2ToXLSX
};

export default salesbudgetv2;