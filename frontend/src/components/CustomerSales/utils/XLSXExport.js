// frontend/src/components/CustomerSales/utils/XLSXExport.js
...
function XLSXExport(data, fileName = 'CustomerSalesData.xlsx') {
  ...
  const worksheet = XLSX.utils.json_to_sheet(data.map(d => ({
    ...
    header: ['Grup','Müşteri Kodu', 'Müşteri Adı', 'Yıllık Toplam', 'Ocak', 'Şubat', 'Mart', 'Nisan', 'Mayıs', 'Haziran', 'Temmuz', 'Ağustos', 'Eylül', 'Ekim', 'Kasım', 'Aralık'],
    skipHeader: true,
  });
