...
import '../css/ColumnFilter.css'; // Stiller ana tablo CSS dosyasından geliyor
...
export const ColumnFilter = ({ column }) => {
  ...
  return (
    <span className="customer-sales-columnfilter">
      <input
        className="customer-sales-columnfilter__input"
        value={filterValue || ''}
