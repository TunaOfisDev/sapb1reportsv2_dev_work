// frontend/src/components/DeliveryDocSum/containers/DeliveryDocSumContainer.js
  ...
  return (
    <ErrorBoundary>
      <div className="delivery-doc-sum-container">
        ...
        <DeliveryDocSumTable data={data} />
      </div>
    </ErrorBoundary>
  );
};

export default DeliveryDocSumContainer;
