...
function convertToSheetData(data) {
  return data.map(d => ({
    ...
    Açık_Net: formatNumber(d.acik_net_tutar_ypb),
    Girsberger_Net: formatNumber(d.girsberger_net_tutar_ypb),
    Mamul_Net: formatNumber(d.mamul_net_tutar_ypb),
    Ticari_Net: formatNumber(d.ticari_net_tutar_ypb),
    Nakliye_Net: formatNumber(d.nakliye_net_tutar_ypb),
    Montaj_Net: formatNumber(d.montaj_net_tutar_ypb)
  }));
}
