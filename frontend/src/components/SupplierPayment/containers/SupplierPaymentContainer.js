// frontend/src/components/SupplierPayment/containers/SupplierPaymentContainer.js
...
const SupplierPaymentContainer = () => {
  const {
  ...
  return (
    <div className="supplier-payment-container">
      <div className="supplier-payment-container__header">
        <h1 className="supplier-payment-container__title">Tedarikçi Ödemeleri</h1>
...
export default SupplierPaymentContainer;