// frontend/src/components/TotalRisk/containers/TotalRiskContainer.js
...
const TunaInsSupplierAdvanceBalanceContainer = () => {
    ...
    <div className="total-risk-container">
      <div className="total-risk-container__header">
        <h1 className="total-risk-container__title">
          Tuna Ins Tedarikci Avans Listesi
        </h1>
        {lastUpdated && (
...
export default TunaInsSupplierAdvanceBalanceContainer;
